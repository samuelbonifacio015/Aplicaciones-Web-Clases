...
public class Developer
{
    ...
    /// <summary>
    /// Gets the developer FirstName.
    /// </summary>
    public string FirstName { get; }
    
    /// <summary>
    /// Gets the developer LastName.
    /// </summary>
    public string LastName { get; }
    
    /// <summary>
    /// Initializes a new instance of the Developer class with the privded first and last names.
    /// </summary>
    /// <param name="firstName">The developer's frist name, may be null or contain whitespace</param>
    ...
    /// <summary>
    /// Returns the full name of the developer concatenating first and last names
    /// </summary>
